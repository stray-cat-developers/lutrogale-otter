...
class PreconditionFailException(
    message: String,
) : HumanException(DefaultError(ErrorCode.HD02, message))
...
class MissingRequestXHeaderException(
    headerName: String,
) : HumanException(DefaultError(ErrorCode.HI02, "Missing request header $headerName"))

class InvalidArgumentException(
    message: String,
) : HumanException(DefaultError(ErrorCode.HI01, message))
